    ...
    <div className="px-2 md:px-4 py-1 mb-5 w-full mt-2 text-sm text-white bg-brand-50 dark:bg-blue-500/20 border-brand-700 dark:border-blue-400 border  relative">
      <div className="text-left gap-3 fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div className="relative z-10 flex flex-col text-left gap-4 p-6 bg-[#fff] dark:bg-blue-500/20 border-brand-700 dark:border-blue-400 border-2 rounded-lg shadow-lg ">
          ...
          <p className="text-xs text-center text-brand-500 dark:text-white">You have successfully verified your mail</p>
    ...
    <div className="px-2 md:px-4 py-1 mb-5 w-full mt-2 text-sm text-white bg-brand-50 dark:bg-blue-500/20 border-brand-700 dark:border-blue-400 border  relative">
      <div className="text-left gap-3 fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div className="relative z-10 flex flex-col text-left gap-4 p-6 bg-[#fff] dark:bg-blue-500/20 border-brand-700 dark:border-blue-400 border-2 rounded-lg shadow-lg ">
          ...
          <h1 className="text-xl text-center mt-2 mb-2 font-medium text-brand-500 dark:text-white">Account Creation Successful!</h1>  
          <p className="text-xs text-center text-brand-500 dark:text-white">Congratulations! your account has been successfully created. You can now proceed to the dashboard to access our services.</p>
          <Link to="/dashboard"><button type="button" className="text-xs bg-brand-500 text-white dark:bg-white dark:text-brand-500 m-auto w-full px-5 py-3 rounded-full font-medium">Proceed to dashboard</button></Link>
        </div>
      </div>
    </div>
