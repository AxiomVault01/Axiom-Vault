  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 sm:p-6 md:p-8 dark:bg-white/[0.03] dark:text-white">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden  dark:bg-white/[0.03] dark:text-white">
        ...
        {!isVerified && (
          <div className="p-4 sm:p-6 md:p-8 bg-red-50 border-b  dark:bg-white/[0.03] dark:text-white">
        ...
        {!isVerified && (
          <div className="p-4 sm:p-6 md:p-8 bg-gray-50 border-t  dark:bg-white/[0.03] dark:text-white">
            <h3 className="text-lg font-bold text-gray-800 mb-4 dark:text-white">
              Risk Assessment
            </h3>
        ...
        {/* Action Buttons */}
        <div className="p-4 sm:p-6 md:p-8 bg-gray-50 border-t flex flex-col sm:flex-row gap-3 sm:gap-4 justify-end  dark:bg-white/[0.03] dark:text-white">
          <button
            onClick={() => navigate(-1)}
