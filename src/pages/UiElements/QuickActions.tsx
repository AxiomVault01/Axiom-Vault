...
import { Download, Search, File, Bell, Shield } from "lucide-react";
...
const QuickActions = () => {
  ...
  return (
    <div className="xl:max-w-200 lg:w-full rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/3 md:p-5">
      {/* Title */}
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
        {actions.map((action) => (
          <button
            ...
            className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-gray-700 transition-all dark:bg-white/3! dark:text-white/90 dark:hover:!bg-white/8!"
            onMouseEnter={(e) =>
      ...
      {/* System Status */}
      <div className="mt-4 p-4 bg-green-50 border border-green-300 rounded-lg dark:bg-gray-900!">
        <div
          style={{
            display: "flex",
            alignItems: "center",
        ...
        >
          <span style={{ fontSize: "18px" }}><Shield size={18} className="text-green-600"/></span>
